...
class DatabaseMethods {
  ...
  Future<Stream<QuerySnapshot>> adminOrders(String category) async {

    if (category == "Packaging") {
      return await FirebaseFirestore.instance.collection("Orders").where("Status", isEqualTo: "Packaging").snapshots();
    } else if (category == "On the Way") {
      ...
      return await FirebaseFirestore.instance.collection("Orders").where("Status", isEqualTo: "Delivered").snapshots();
  ...
  updateStatus(String id,String status) async {
    return await FirebaseFirestore.instance.collection("Orders").doc(id).update({"Status": status});
  }
